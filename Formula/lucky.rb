...
class Lucky < Formula
  ...
  license "MIT"
  url "https://github.com/luckyframework/lucky_cli/archive/refs/tags/v1.4.0.zip"
  sha256 "d5f7fcc0aa59dd1563608e104d196863853e6d6291e54e8c1d5e8f9db474d37a"
  ...
  test do
    assert_equal "1.4.0", shell_output("#{bin}/lucky --version").strip
  end
end
